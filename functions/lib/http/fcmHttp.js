...
exports.sendTestNotification = exports.saveNotificationSettings = exports.getNotificationSettings = exports.deleteFCMToken = exports.saveFCMToken = void 0;
const https_1 = require("firebase-functions/v2/https");
const fcmService_1 = require("../services/fcmService");
const auth_1 = require("../utils/auth");
// FCM 토큰 저장
exports.saveFCMToken = (0, https_1.onRequest)({
    region: 'asia-northeast3',
    cors: true,
}, async (req, res) => {
    try {
        // 인증 확인
        const user = await auth_1.AuthUtils.verifyToken(req);
        if (!user) {
        ...
        await fcmService_1.FCMService.saveToken(user.uid, token, platform);
...
// FCM 토큰 삭제
exports.deleteFCMToken = (0, https_1.onRequest)({
    region: 'asia-northeast3',
    cors: true,
}, async (req, res) => {
    try {
        ...
        await fcmService_1.FCMService.deleteToken(token);
...
// 알림 설정 조회
exports.getNotificationSettings = (0, https_1.onRequest)({
    region: 'asia-northeast3',
    cors: true,
}, async (req, res) => {
    try {
        ...
        const settings = await fcmService_1.FCMService.getNotificationSettings(user.uid);
        if (!settings) {
            // 기본 설정 반환
...
// 알림 설정 저장
exports.saveNotificationSettings = (0, https_1.onRequest)({
    region: 'asia-northeast3',
    cors: true,
}, async (req, res) => {
    try {
        ...
        await fcmService_1.FCMService.saveNotificationSettings(settings);
...
exports.sendTestNotification = (0, https_1.onRequest)({
    ...
    try {
        ...
        const success = await fcmService_1.FCMService.sendPushNotification(user.uid, template);
        if (success) {
...
//# sourceMappingURL=fcmHttp.js.map